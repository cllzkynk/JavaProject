...
public class Otomat03 {
    String urun = "";
    Integer urunBedeli = 0;
    static Byte urunKodu = 0;
    static private String otomatSifre = "1453";
    static HashMap<Byte, List<Otomat03>> otomat = new HashMap<>();
    static Scanner scan = new Scanner(System.in);

    public Otomat03(String urun, Integer urunBedeli) {
        this.urun = urun;
    ...
    private static void urunAl() throws InterruptedException {
        ...
        if (otomat.isEmpty()) {
            ...
            do {
                for (Map.Entry<Byte, List<Otomat03>> w : otomat.entrySet()) {
                ...
                if (otomat.containsKey(kod)) {
                    ...
                    List<Otomat03> urunBilgileri = otomat.get(kod);
        ...
        while (sifreHak != 0) {
            ...
            if (sifre.equals(otomatSifre)) {
                ...
                do {
                    ...
                    Otomat03 o = new Otomat03(urun, satisFiyati);
                    List<Otomat03> urunler = new ArrayList<>();
                    urunler.add(o);
